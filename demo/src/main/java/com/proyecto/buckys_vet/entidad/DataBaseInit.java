...
public class DataBaseInit implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        for (int i = 0; i < 50; i++) {
            ...
            String imagenUrl = esHombre ? IMAGENES_DUENOS_HOMBRES[random.nextInt(IMAGENES_DUENOS_HOMBRES.length)]
        ...
        for (int i = 0; i < 100; i++) {
            ...
            String imagenMascota = especie.equals("Perro") ? IMAGENES_PERROS[random.nextInt(IMAGENES_PERROS.length)]
        ...
        for (int i = 0; i < 10; i++) {
            Tratamiento t = new Tratamiento(java.time.LocalDate.now().minusDays(i), "Tratamiento " + i, vets.get(i),
        ...
        for (Tratamiento tratamiento : todosTratamientos) {
            if (tratamiento.getMascota() != null && tratamiento.getVeterinario() != null) {
                mascotaVeterinarioMap.put(tratamiento.getMascota().getMascotaId(), tratamiento.getVeterinario());
            }
        }
